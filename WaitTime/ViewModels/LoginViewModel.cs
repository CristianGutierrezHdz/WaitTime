using WaitTime.Validators;
using WaitTime.Validators.Rules;
using Xamarin.Forms.Internals;

namespace WaitTime.ViewModels
{
    /// <summary>
    ...
    public class LoginViewModel : BaseViewModel
    {
        ...
        {
            this.Email.Validations.Add(new IsNotNullOrEmptyRule<string> { ValidationMessage = "Correo Requerido" });
            this.Email.Validations.Add(new IsValidEmailRule<string> { ValidationMessage = "Correo Invalido" });
        }
